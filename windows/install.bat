...
powershell -Command "Invoke-WebRequest https://github.com/ytdl-org/youtube-dl/releases/download/2020.09.20/youtube-dl.exe -OutFile C:\Windows\youtube-dl.exe"
